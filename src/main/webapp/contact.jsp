                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="contact.jsp">联系我们</a></li>
        ...
        <section class="breadcrumb_area">
            ...
            <div class="container">
                <div class="page-cover text-center">
                    <h2 class="page-cover-tittle">联系我们</h2>
                    <ol class="breadcrumb">
                        ...
                        <form class="row contact_form"  id="contactForm" novalidate="novalidate">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="uname" name="name" value="${loginuser.uname }" readonly="readonly">
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control" id="iemail" name="email" placeholder="输入电子邮件地址">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="icontent" name="subject" placeholder="输入主题">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <textarea class="form-control" name="message" id="remark" rows="1" placeholder="输入消息"></textarea>
                                </div>
                            </div>
                            <div class="col-md-12 text-right">
                                <button class="btn theme_btn button_hover" onclick="addcomment()">发送消息</button>
                            </div>
                        </form>
                    </div>
                </div>
