								...
								<center>
        								...
        								<div id="modal3" class="modal">
        									<div class="modal-content3">
        										...
        										<form action="../../user.do?method=AddGenUser"  method="post">
        											<div class="modal-body" style="margin-bottom: 50px;">
        												<p class="p1">姓名：<input type="text" name="uname1" value="" /></p>
        												<p class="p1">手机号：<input type="text" name="phone1" value="" /></p>
        												<p class="p1">身份证：<input type="text" name="idcard1" value="" /></p>
        												<p class="p1"><input type="text" name="jurisdiction1" value="非会员" hidden="hidden" /></p>
        												<p class="p1">注册时间：<input type="text" name="regtime1" value="" /></p>
        											</div>
        											<footer class="modal-footer">
        												<button id="cancel3">取消</button>
									...
									<form action="" method="post" class="sousuo">
											<input type="text" name="phone" class="str" placeholder="请输入手机号查询"><button onclick="select()" type="button" >搜索</button>
...
<script src="${pageContext.request.contextPath}/js/jquery.min.js"></script>
                             <script type="text/javascript">
                            	...
                            	function pageNumber(page,phone) {
									$.post({
										type:'post',
										url:'../../user.do?method=FindGenUser',
										data:{phone:$('.str').val(),pagenumber:page},
										success : function(data) {
											...
											for (var i = 0; i < obj.length; i++) {
												str+="<tr>"
					                                ...
					                                +"<td>"+obj[i].regtime+"</td>"
					                                +"<td>"
					                                +"<button type=\"button\" class=\"btn1\" id='showModel"+obj[i].uid+"' onclick=\"f1('"+obj[i].uid+"')\">删除</button>"
												    ...
												    +"</div>"
												    +"<footer class=\"modal-footer\">"
												    +"<button id='cancel"+obj[i].uid+"' class=\"active\"  type=\"button\">取消</button>"
												    +"<a href=\"../../user.do?method=DelUser2&uid="+obj[i].uid+"\"><button id=\"sure\">确定</button></a>"
												    +"</footer>"
												    +"</div>"
												    +"</div>"
												    +"<button type=\"button\" class=\"btn2\" id='showModel2"+obj[i].uid+"' onclick=\"f2('"+obj[i].uid+"')\">修改</button>"
												    ...
												    +"</header>"
												    +"<form action=\"../../user.do?method=UpUser2\" method=\"post\" >"
												    +"<div class=\"modal-body\">"
												    +"<p><input type=\"text\" name=\"uid\" value="+obj[i].uid+" hidden=\"hidden\" /></p>"
												    +"<p class=\"p1\">姓名：<input type=\"text\" name=\"uname\" value='"+obj[i].uname+"'  disabled=\"disabled\"/></p>"
												    +"<p class=\"p\">手机号：<input type=\"text\" name=\"phone\" id=\"phone\" value='"+obj[i].phone+"' /></p>"
												    +"<p class=\"p\">身份证：<input type=\"text\" name=\"idcard\" value='"+obj[i].idcard+"' disabled=\"disabled\"/></p>"
												    +"<p class=\"p1\">权限：<input type=\"text\" name=\"jurisdiction\" value='"+obj[i].jurisdiction+"' disabled=\"disabled\"/></p>"
												    +"<p>注册时间：<input type=\"text\" name=\"regtime\" value='"+obj[i].regtime+"' disabled=\"disabled\"/></p>"
												    +"</div>"
												    +"<footer class=\"modal-footer\">"
												    +"<button id='cancel2"+obj[i].uid+"' type=\"button\">取消</button>"
