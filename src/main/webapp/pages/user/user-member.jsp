						...
						<li class="nav-item">
							...
							<div class="collapse" id="user_manage">
								<ul class="nav flex-column sub-menu">
									<li class="nav-item">
										<a id="aaa" class="nav-link" href="user-member.jsp">会员信息管理</a>
									</li>
									<li class="nav-item">
										...
										success : function(data) {
											...
											for (var i = 0; i < obj.length; i++) {
												str+="<tr>"
												    ...
												    +"<a href=\"../../user.do?method=DelUser&uid="+obj[i].uid+"\"><button id=\"sure\">确定</button></a>"
												    +"</footer>"
												    +"</div>"
												    +"</div>"
												    ...
												    +"</header>"
												    +"<form action=\"../../user.do?method=UpUser\" method=\"post\" >"
												    +"<div class=\"modal-body\">"
												    ...
												    +"<p class=\"p1\">密码：<input type=\"text\" name=\"upassword\" id=\"upassword\" value='"+obj[i].upassword+"' /></p>"
												    ...
												    +"<p>登录状态：<input type=\"text\" name=\"status\" value='"+obj[i].ustatus+"' disabled=\"disabled\"/></p>"
												    +"<p class=\"p1\">余额：<input type=\"text\" name=\"balance\" value='"+obj[i].balance+"' disabled=\"disabled\"/></p>"
												    +"</div>"
												    +"<footer class=\"modal-footer\">"
