							...
							<div class="container text-center">
								<div class="biao">
								 <center> 
										...
										<input type="text" name="sousuo" id="selectvalue"  placeholder="请输入房间状态">
	                                ...
	                                function pageNumber(page,name) {
										$.post({
											type:'post',
											url:'../../zroom.do?method=findby',
											data:{"pageNum":page,"zstatus":name},
											success : function(data) {
											...
											str+="<tr>"
												...
												+"<td>"+obj[i].zstatus+"</td>"
												+"<td>"
													+"<button type='button' onclick='modeldel("+obj[i].zid+")' class='btn2' id='showModel"+obj[i].zid+"'><a href='#'>修改</a></button>"
													+"<div id='modal"+obj[i].zid+"' class='modal'>"
														+"<div class='modal-content2'>"
														+"<header class='modal-header'>"
														+"<h4>修改信息</h4>"		
														+"<span class='close"+obj[i].zid+"'>×</span>"
														+"	</header>"
															+"<form action='../../zroom.do?method=updateall' method='post'>"
														+"<div class='modal-body' style='margin-bottom: 50px;'>"
														+"<p class='p'><input type='text' name='zid' value='"+obj[i].zid+"' hidden='hidden'/></p>"
														+"<p class='p'>类型：<select name='rid' id='rid'> "  
												       +"<option value='1'>豪华单人套房</option>"    
												       +"<option value='2'>双人豪华客房</option>"    
												        +"<option value='3'>蜜月旅行套装</option>"   
												       +" <option value='4'>经济实惠套房</option>  "
												       +"</p>"
														+"<p>房间号：<input type='text' name='zname' value='"+obj[i].zname+"' /></p>"
														+"<p class='p'>状态：<input type='text' name='zstatus' value='"+obj[i].zstatus+"' /></p>"
														+"</div>"
														+"<footer class='modal-footer'>"
														+"<button id='cancel"+obj[i].zid+"'>取消</button>"
