...
/* 		var vNow = new Date();
		...
		document.getElementById("WIDout_trade_no").value =  "${aiList[0]}";
		document.getElementById("WIDsubject").value = "${aiList[1]}";
		document.getElementById("WIDtotal_amount").value = "${aiList[2]}";
		document.getElementById("WIDbody").value = "${aiList[3]}";
	}
	GetDateNow();
</script>
</html>