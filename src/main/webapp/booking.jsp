...
<html lang="en">
	...
	<body>
		...
		<section class="breadcrumb_area">
			...
			<div class="container">
				<div class="page-cover text-center">
					<h2 class="page-cover-tittle">预订</h2>
					<ol class="breadcrumb">
						<li>
		...
		<!--================Breadcrumb Area =================-->
		<!--================Booking Tabel Area =================-->
		<section class="hotel_booking_area" style="margin-bottom: 30px;margin-top: 30px;">
			<div class="container">
						...
						<div class="boking_table">
							<div class="row">
									...
									<div class="book_tabel_item">
										<div class="input-group">
											<div class="nice-select"   tabindex="0" style="width: 100%;">
												<span class="current" id="rimg">${roomrid.rtype }</span>
										...
										<div class="input-group" id="input1">
											<input class="inputss" type='text' disabled='disabled' placeholder="${roomrid.rprice }" value="${roomrid.rprice }" id='rprice' />
										</div>
									</div>
									<div class="book_tabel_item">
										<div class="input-group">
											<div class="nice-select"   tabindex="0" style="width: 100%;">
												<span class="current" id="zname">房间编号</span>
		 										<ul class="list" id="input2">
		 											<c:forEach var="zss" items="${zroomrid }"> 
		 												<li id="" class="option" value="${zss.zid }">${zss.zname }</li>
		 											</c:forEach>
		 										</ul>
											</div>
										</div>
								...
								<div class="col-md-6" id="img1">
									<img src="${roomrid.rimg}" style="width: 100%;height: 80%;"/>
								</div>
							</div>
						</div>
					</div>
        	...
        	function get(rid){
        	   ...
        	   $.ajax({
        	        ...
        	        success: function(data){
        	        	...
        	        	var str1 ="<input class=\"inputss\" type=\'text\' disabled='disabled' placeholder=\"房间价格\" id='rprice' value=\""+data.rprice+"\" />";
        	        	$("#input1").html(str1);
        	       	},
				    error:function(){
					  alert('错了2');
        	...
        	function get3(rid){
          	   $.post({
          	        ...
          	        success: function(data){
          	        	var ss=data;
          	        	var str1="";
 	   	            	str1+="<img src=\""+ss.rimg+"\" style=\"width: 100%;height: 80%;\"/>";
          	        	$("#img1").html(str1);
          	       	},
  				    error:function(){
  					  alert('错了4');
